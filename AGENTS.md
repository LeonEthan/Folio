...
Design history uses a Molly Design-managed local Git repository only, isolated from user
...
- OSS desktop is local-only: no authenticated product-cloud requests or telemetry.
  Public runtime and Molly Design update downloads are exceptions.
