...
`@geon/design-authoring` migrates the PPTD **intake and projection** subset of the upstream
authoring pipeline into Geon: fail-closed PPTD snapshot validation, PPTD →
