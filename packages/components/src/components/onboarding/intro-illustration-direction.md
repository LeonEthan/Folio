# Molly Design opening direction

The independent-release specification selects paper and typography: restrained,
precise, warm and useful. The vector mark is a single handwritten stroke forming an M
with a gentle lead-in, drawn in ink on a ruled-paper tile — a hand gesture on
designer paper, matching the product's editable-text promise.
It was selected from three gestural candidates (one-stroke M, handwritten M with
lead-in, two-stroke marker M) after an earlier stroked-wordmark direction with a red
swash was narrowed down: no accent color without a specific reason, simplest possible
strokes, one M character; review drafts live in
`output/molly-logo-candidates/`, outside product source. The editable source is
`../../assets/molly-mark.svg`; PNG/ICNS/ICO exports serve actual app consumers.
...
1. Poster design: `../../assets/molly-poster-v3.png` - nocturnal botanical cyanotype and elegant display type.
2. Editorial design: `../../assets/molly-editorial-v3.png` - plum-toned food journal, large serif type and magazine columns.
3. Brand identity: `../../assets/molly-brand-v3.png` - a mint-green sound festival identity extended to wristbands, lineup graphics and passes.
4. E-commerce product details: `../../assets/molly-commerce-v3.png` - burgundy espresso-maker A+ hero, detail modules and outdoor use scene.

The artworks deliberately differ in palette, medium and composition. The restrained
Molly Design shell unifies them; progression comes from expression, editorial structure,
...
`../../assets/molly-opening-v1.mp3` uses its opening 20 seconds, normalized to
