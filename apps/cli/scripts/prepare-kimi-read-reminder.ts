...
const manifest = {
  ...
  version: '0.1.0',
  description: 'Read-before-edit reminders in Molly Design design launches only.',
  hooks: [
    {
...
await writeFile(
  ...
  '// Generated from Molly Design DESIGN_READ_BEFORE_EDIT_REMINDER. No installation side effects.\n' +
