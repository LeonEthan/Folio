...
reminder event, but Molly Design has no verified session-scoped hook loading path that
...
can emit the shared reminder only for Molly Design-marked design launches; real-user
