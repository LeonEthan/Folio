export const DESIGN_READ_BEFORE_EDIT_REMINDER =
  'Folio file editing reminder: Before modifying an existing file, read its current disk contents. ' +
  ...
  'do not edit a retained draft using only memory from an earlier turn. ' +
  'This reminder does not synchronize files, prove a read, authorize a commit, or replace native tool checks.';
