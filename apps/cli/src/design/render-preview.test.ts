/**
 * Preview rendering: a synthetic YAML artwork in a session workdir is staged
 * for the desktop, and the file the desktop writes back is verified before its
 * path is handed to any agent.
 *
