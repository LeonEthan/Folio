...
/** Same local Git executable as Lody; no shell, user index, remote or hook execution. */
    ...
    const child = execFile(
      ...
      ['--git-dir', repository, '-c', `core.hooksPath=${devNull}`, ...args],
      {
        ...
        env: {
          ...
          GIT_AUTHOR_NAME: 'Folio',
          GIT_AUTHOR_EMAIL: 'folio@localhost',
          GIT_COMMITTER_NAME: 'Folio',
          GIT_COMMITTER_EMAIL: 'folio@localhost',
        },
      },
      (error, stdout) => {
