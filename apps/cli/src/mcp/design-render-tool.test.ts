/**
 * `molly_render_preview` (P2.4b): the tool exists exactly while a Molly Design desktop
 ...
 * see the tool at all, and should be told to ask the user to open Molly Design.
 *
