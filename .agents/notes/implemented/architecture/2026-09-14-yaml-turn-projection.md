...
Linked to the approved [graphic design platform](../../../../specs/graphic-design-platform.md) 2026-09-14 revision, the [retirement proposal](../../proposed/architecture/2026-09-14-retire-kimi-pptd-authoring.md), the [YAML snapshot contract](2026-09-14-yaml-authoring-snapshot.md), and [#38](https://github.com/LeonEthan/Geon/issues/38).
