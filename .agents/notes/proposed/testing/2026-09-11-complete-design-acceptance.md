...
records the failing default-view regression and verification limits. Supplemental
real MCP calls remain separate technical coverage, and no public release was
authorized.
