...
package, establish every recovery path, or complete T29. Pi image MCP remains
unavailable through its adapter, which does not forward the catalog. Codex/Kimi/Grok
