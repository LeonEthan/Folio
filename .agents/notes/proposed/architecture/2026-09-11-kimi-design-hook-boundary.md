...
The pinned Kimi runtime cannot currently provide Folio's complete successful-read
...
and [Issue #21](https://github.com/LeonEthan/Folio/issues/21). The existing
...
advertised no Folio design generation/read contract. The runtime's source pins
