...
assert(process.env.MOLLY_E2E_INSTALLED_EXECUTABLE, 'Set the final installed executable');
assert(process.env.MOLLY_E2E_EXPECTED_SOURCE_COMMIT, 'Set its sealed source commit');
